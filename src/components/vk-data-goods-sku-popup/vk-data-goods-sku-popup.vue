                            ...
                            <view class="item-wrapper">
                                <view
                                    ...
                                    :style="[
                                        item_value.ishow
                                            ? ''
                                            : themeColorFn('disableStyle'),
                                        item_value.ishow
                                            ? themeColorFn('btnStyle')
                                            : '',
                                        subIndex[index1] == index2
        ...
        getListItem(list, key, value) {
            ...
            for (let i in list) {
                if (typeof value == 'object') {
                    if (
                        JSON.stringify(list[i][key]) === JSON.stringify(value)
                    ) {
                        item = list[i]
                        break
                    }
