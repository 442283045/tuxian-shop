...
const selectArrText = computed(() => {
    ...
    return skuPopupRef.value?.selectArr?.join(' ')
})
...
<template>
    ...
    <scroll-view scroll-y class="viewport">
        ...
        <view class="goods">
            ...
            <!-- 操作面板 -->
            <view class="action">
                <view @tap="isShowSkuPopup = true" class="item arrow">
    ...
    >
        <view class="icons">
            ...
            <navigator
                class="icons-button"
                url="/pages/cart-normal/cart-normal"
                open-type="navigate"
            >
        ...
        <view class="buttons">
            ...
            <view class="buynow" @tap="openSkuPopup(SkuMode.Buy)">
                立即购买
            </view>
        </view>
    </view>
